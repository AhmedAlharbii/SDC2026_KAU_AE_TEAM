...
- [Background & The Global Problem](#1-background--the-global-problem)
- [The Competition & Dataset](#2-the-competition--dataset)
- [Literature Review & Prior Art](#3-literature-review--prior-art)
- [Our Proposed Solution — The Core Idea](#4-our-proposed-solution--the-core-idea)
- [Data: From Raw KVN to Structured CSV](#5-data-from-raw-kvn-to-structured-csv)
- [Feature Engineering & Sequence Preparation](#6-feature-engineering--sequence-preparation)
- [Model Architecture — The BiGRU](#7-model-architecture--the-bigru)
- [Training Strategy & Optimization](#8-training-strategy--optimization)
- [Uncertainty Quantification — MC Dropout](#9-uncertainty-quantification--mc-dropout)
- [Scoring System — Threat & Confidence](#10-scoring-system--threat--confidence)
- [The Evaluation Gate — Step 3B](#11-the-evaluation-gate--step-3b)
- [Production Inference — The Dashboard](#12-production-inference--the-dashboard)
- [Visualization & Reporting](#13-visualization--reporting)
- [Software Architecture & Pipeline Design](#14-software-architecture--pipeline-design)
- [Testing Strategy & Test Suite](#15-testing-strategy--test-suite)
- [Problems Encountered & How We Solved Them](#16-problems-encountered--how-we-solved-them)
- [Results & Performance](#17-results--performance)
- [Libraries, Frameworks & Tools](#18-libraries-frameworks--tools)
- [Lessons Learned & Future Work](#19-lessons-learned--future-work)
- [Team & Acknowledgments](#20-team--acknowledgments)
- [References & Citation](#21-references--citation)
